...
| [`docs/10-tong-hop.md`](docs/10-tong-hop.md) | **Tài liệu chốt** sau bốn vòng review: 8 quyết định kiến trúc, bản đồ tài liệu, những gì đã bác bỏ và vì sao, còn gì mở, bắt đầu từ đâu |
| [`docs/11-de-xuat.md`](docs/11-de-xuat.md) | Đề xuất + phản biện của vòng review độc lập, kèm mục "đã xử lý": nhận gì, bác gì, vì sao |
